...
bool CompareMatrix(const ChCSR3Matrix& mat1, const mat_t& mat2)
{
...
bool test_MatrMultriply(bool transposeA)
{
    ...
    ChCSR3Matrix matA_rm(3, 3, true);
    ChCSR3Matrix matA_cm(3, 3, false);
...
bool test_MatrMultriplyClipped()
{
    ...
    ChCSR3Matrix matA_cm(6, 4);
    ChCSR3Matrix matA_cmT(4, 6);
