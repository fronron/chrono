...
IF (MUMPS_ONLY_LIBRARY_ARITHMETIC_SPECIFIC AND MUMPS_ONLY_INCLUDE_DIRS)
	...
	IF (MUMPS_SHARED OR MUMPS_ONLY_LIBRARY_COMMON)
...
IF (MUMPS_MPI_INCLUDE_DIRS AND (MUMPS_SHARED OR MUMPS_MPI_LIBRARIES))
	SET(MUMPS_MPI_FOUND TRUE)
endif()
...
IF (MUMPS_ONLY_FOUND)
	...
	ELSE ()
		MESSAGE(STATUS "Mumps found, but other needed libraries are missing.")
