...
IF (MUMPS_ONLY_LIBRARY_COMMON AND MUMPS_ONLY_LIBRARY_ARITHMETIC_SPECIFIC AND MUMPS_ONLY_INCLUDE_DIRS)
...
ELSE (MUMPS_USE_MPI)
	...
	find_library(MUMPS_MPI_LIBRARIES
				libmpiseq
				PATHS ${MUMPS_ROOT}
				PATH_SUFFIXES "libseq" "libseqmpi"
				NO_DEFAULT_PATH
			    NO_SYSTEM_ENVIRONMENT_PATH
	)
...
IF (MUMPS_MPI_LIBRARIES AND MUMPS_MPI_INCLUDE_DIRS)
	SET(MUMPS_MPI_FOUND TRUE)
ENDIF()
...
IF (MUMPS_USE_DEFAULT_ORDERINGS)
	...
	find_library(MUMPS_ORDERINGS_LIBRARIES
				libpord
				PATHS ${MUMPS_ROOT}
				PATH_SUFFIXES "PORD/lib" "PORD" "PORD/libraries"
	)
...
IF (MUMPS_ORDERINGS_LIBRARIES AND MUMPS_ORDERINGS_INCLUDE_DIRS)
...
################# Exported variables #####################		
IF (MUMPS_ONLY_FOUND AND MUMPS_MPI_FOUND AND MUMPS_ORDERINGS_FOUND)
